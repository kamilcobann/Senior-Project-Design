...
class ProjectController extends Controller
{
    public function getAllProjects(Request $request)
    {
        ...
        try {
            $projects = Project::withCount('kanbans')->with(['members','kanbans.kanbanLists.tickets.comments','budgets.expenses'])->get();
    ...
    public function getAllProjectsOfUser(Request $request)
    {
        ...
        try {
            $projects = Project::where('by_user_id', $request->user()->id)->with(['members','kanbans.kanbanLists.tickets.comments','budgets.expenses'])->get();
    ...
    public function getProjectById($id)
    {
        ...
        try {
            $project = Project::with(['members','kanbans.kanbanLists.tickets.comments','owner','budgets.expenses'])->withCount('members')->findOrFail($id);
    ...
    {
        try {
            $project = Project::whereId($id)->where("by_user_id", $request->user()->id)->with(['members','kanbans.kanbanLists','budgets.expenses'])->first();
    ...
    public function addMemberToProject(Request $request, $id)
    {
        try {
            ...
            $project = Project::with(['members','kanbans.kanbanLists.tickets.comments','budgets.expenses'])->withCount('members')->findOrFail($id);
